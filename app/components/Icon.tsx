...
const ICONS: Record<string, string> = {
  ...
  heart:
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 21s-7.5-4.6-10-9.2C.6 8.9 2 5.5 5.2 5.5c2 0 3.2 1.2 3.8 2.3C9.6 6.7 10.8 5.5 12.8 5.5 16 5.5 17.4 8.9 16 11.8 13.5 16.4 12 21 12 21z" transform="translate(-0.4 0)"/></svg>',
  classic:
  ...
  heartOutline:
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 20.3s-6.8-4.2-9.1-8.4C1.6 9.4 2.9 6.3 5.8 6.3c1.8 0 2.9 1.1 3.4 2.1.5-1 1.6-2.1 3.4-2.1 2.9 0 4.2 3.1 2.9 5.6-2.3 4.2-9.1 8.4-9.1 8.4z" transform="translate(0.5 0)"/></svg>',
  cart:
  ...
  heartFill:
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 20.3s-6.8-4.2-9.1-8.4C1.6 9.4 2.9 6.3 5.8 6.3c1.8 0 2.9 1.1 3.4 2.1.5-1 1.6-2.1 3.4-2.1 2.9 0 4.2 3.1 2.9 5.6-2.3 4.2-9.1 8.4-9.1 8.4z" transform="translate(0.5 0)"/></svg>',
  clock:
